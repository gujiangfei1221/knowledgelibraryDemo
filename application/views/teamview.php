        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="home3">
                    ...
                    <ol>
                        <li>性能测试、安全测试、自动化测试、项目部署等技术研究工作</li>
                        <li>测试技术疑难问题，研究后共享培训</li>
                        <li>承担较复杂的项目性能测试工作，普通项目性能测试工作，仍为原测试小组承担</li>
                        <li>承担安全测试、渗透测试，安全测试用例等</li>
                        <li>测试服务器，维护</li>
                        <li>承担适量的普通项目测试工作，暂定不多于小组精力的40%</li>
                        <li>目前手上需要移交的任务，平稳过渡</li>
                    </ol>
                    ...
                    <ol>
                        <li>预算来源：性能测试、安全测试预算使用项目组预算，组外预算拨过来；部分小项目承担功能测试，预算直接拨过来；研究任务暂时使用部门预算；从框架组申请拨过来或者单独立项（待定）</li>
                        <li>预算使用做好记录；测试的功能测试项目、性能测试项目、安全测试项目做好记录；研究项目做好记录</li>
                        <li>小组的事情分类：
                        ...
                        <li>小组成员全能化培养和专精化培养
                            ...
                            <ul>
                                <li>全能化培养：主要负责性能测试的人员可以应付普通项目的安全性测试；主要负责安全测试的人员可以应付普通项目的性能测试</li>

...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <?php echo form_open('Testinfo/search', 'class="navbar-form navbar-right" role="search"') ?>
            <div class="form-group">
                <?php
                $data = array(
                    'type' => 'text',
                    'class' => 'form-control',
                    'placeholder' => '请输入姓名或系统或浏览器',
                    'name' => 'search'
                );
    ...
    <div class="col-md-8">
        <table class="table table-striped table-hover text-center">
            ...
            <tr>
                ...
                <td><?php echo $row['osinfo'] ?></td>
                <td><?php echo $row['ieinfo'] ?></td>
            </tr>
            <?php endforeach; ?>
